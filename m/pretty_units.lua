...
--- Usage:
---
---    m.format_pretty_unit(10, 's') -- => 10s
---    m.format_pretty_unit(10000, 'l') -- => 10kl
---
...
---   prefixes?: Prefix[]
--- ): String
function m.format_pretty_unit(value, unit, prefixes)
  prefixes = prefixes or m.COMMON_PREFIXES
  unit = unit or ""
...
function m.format_pretty_time(value)
