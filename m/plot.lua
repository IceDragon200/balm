...
function m.plot_line2(x1, y1, x2, y2, callback)
  if callback then
    m.plot_line2_inline(x1, y1, x2, y2, callback)
  else
    return m.plot_line2_iter(x1, y1, x2, y2)
  end
end
...
---   callback: Point2Callback<Integer>
--- ): void
function m.plot_line2_inline(x1, y1, x2, y2, callback)
...
function m.plot_line2_iter(x1, y1, x2, y2)
  assert(x1, "expected x1-coord")
  assert(y1, "expected y1-coord")
  assert(x2, "expected x2-coord")
  assert(y2, "expected y2-coord")
...
function m.plot_line3(x1, y1, z1, x2, y2, z2, callback)
  if callback then
    m.plot_line3_inline(x1, y1, z1, x2, y2, z2, callback)
  else
    return m.plot_line3_iter(x1, y1, z1, x2, y2, z2)
  end
end
...
---   callback: Point3Callback<Integer>
--- ): void
function m.plot_line3_inline(x1, y1, z1, x2, y2, z2, callback)
  local dx = math.abs(x2 - x1)
  local dy = math.abs(y2 - y1)
...
function m.plot_line3_iter(x1, y1, z1, x2, y2, z2)
  local dx = math.abs(x2 - x1)
  local dy = math.abs(y2 - y1)
  local dz = math.abs(z2 - z1)
  local dm = math.max(dx, math.max(dy, dz))
...
--- ): nil | Function/0
function m.walk_ortho2(x1, y1, x2, y2, callback)
  if callback then
    m.walk_ortho2_inline(x1, y1, x2, y2, callback)
  else
    return m.walk_ortho2_iter(x1, y1, x2, y2)
  end
end
...
---   callback: Point2Callback<Number>
--- ): void
function m.walk_ortho2_inline(x1, y1, x2, y2, callback)
  local dx = x2 - x1
  local dy = y2 - y1
  local ix = 0
  local iy = 0
...
function m.walk_ortho2_iter(x1, y1, x2, y2)
  local dx = x2 - x1
  local dy = y2 - y1
  local ix = 0
  local iy = 0
