...
local m = require("balm/m/number")

local case = Luna:new("balm.m.number")
...
case:describe("round/2", function (t2)
  t2:test("can round a floating point number to specified decimal places", function (t3)
    t3:assert_feq(m.number_round(12.7330, 1), 12.7)
    t3:assert_feq(m.number_round(12.123, 2), 12.12)
    t3:assert_feq(m.number_round(12.542, 2), 12.54)
    t3:assert_feq(m.number_round(12.9512, 3), 12.951)
    t3:assert_feq(m.number_round(12.9512, 13), 12.951)
  end)
end)

case:describe("lerp/3", function (t2)
...
case:describe("moveto/3", function (t2)
...
case:describe("interpolate/3", function (t2)
  t2:test("will apply given amount to first value to eventually match second value", function (t3)
